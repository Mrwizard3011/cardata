...
import com.dungphan.cardata.domain.Owner;
import com.dungphan.cardata.domain.OwnerRepository;

@SpringBootApplication
public class CardataApplication implements CommandLineRunner {
	private static final Logger logger = 
			LoggerFactory.getLogger(CardataApplication.class);
	@Autowired
